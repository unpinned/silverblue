...
RUN rpm-ostree override remove gnome-terminal gnome-terminal-nautilus firefox firefox-langpacks && \
    ...
    rpm-ostree override replace https://kojipkgs.fedoraproject.org//packages/glib2/2.74.1/3.fc38/x86_64/glib2-2.74.1-3.fc38.x86_64.rpm https://kojipkgs.fedoraproject.org//packages/gobject-introspection/1.74.0/3.fc38/x86_64/gobject-introspection-1.74.0-3.fc38.x86_64.rpm && \    
